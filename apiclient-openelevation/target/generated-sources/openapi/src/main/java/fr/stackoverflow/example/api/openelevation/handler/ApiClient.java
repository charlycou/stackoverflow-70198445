package fr.stackoverflow.example.api.openelevation.handler;
...
import fr.stackoverflow.example.api.openelevation.handler.auth.Authentication;
...
@Component("fr.stackoverflow.example.api.openelevation.handler.ApiClient")
