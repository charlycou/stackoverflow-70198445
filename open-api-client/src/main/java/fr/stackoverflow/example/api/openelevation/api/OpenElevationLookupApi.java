package fr.stackoverflow.example.api.openelevation.api;

import fr.stackoverflow.example.api.openelevation.handler.ApiClient;

import fr.stackoverflow.example.api.openelevation.model.LocationElevationResultsDTO;
import fr.stackoverflow.example.api.openelevation.model.LocationsPostParam;
...
@Component("fr.stackoverflow.example.api.openelevation.api.OpenElevationLookupApi")
public class OpenElevationLookupApi {
    ...
    public ResponseEntity<LocationElevationResultsDTO> getLookupWithHttpInfo(String locations) throws RestClientException {
        ...
        return apiClient.invokeAPI("/api/v1/lookup", HttpMethod.GET, Collections.<String, Object>emptyMap(), queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, authNames, returnType);
    }
    /**
     * 
    ...
    public ResponseEntity<LocationElevationResultsDTO> postLookupWithHttpInfo(LocationsPostParam locationsPostParam) throws RestClientException {
        ...
        ParameterizedTypeReference<LocationElevationResultsDTO> returnType = new ParameterizedTypeReference<LocationElevationResultsDTO>() {};
        return apiClient.invokeAPI("/api/v1/lookup", HttpMethod.POST, Collections.<String, Object>emptyMap(), queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, authNames, returnType);
    }
}
